...
int main(void)
{
  ...
  /* USER CODE BEGIN 1 */
  // MPU disabled - causes SPI reception issues
  /* USER CODE END 1 */
...
static void MX_GPDMA1_Init(void)
{
  ...
  /* GPDMA1 interrupt Init */
    ...
    HAL_NVIC_SetPriority(GPDMA1_Channel3_IRQn, 2, 0);
...
static void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOB, OT_LD_REV_Pin|OT_LD_SYS_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pins : OT_LD_REV_Pin OT_LD_SYS_Pin */
  GPIO_InitStruct.Pin = OT_LD_REV_Pin|OT_LD_SYS_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(GPIOB, &GPIO_InitStruct);

  /*Configure GPIO pin : IN_RDY_Pin */
  ...
  // PA15: Software NSS + EXTI (IT mode)
  // Falling edge: CS LOW -> Start SPI IT reception
  // Rising edge: CS HIGH -> Transmission complete
  printf("[GPIO] PA15 = SPI1_EXT_NSS (Software NSS + EXTI, IT mode)\r\n");
  printf("[NVIC] EXTI15 interrupt enabled (priority 1)\r\n");
